// Создали сервис для запроса на бекенд для отображения header-bottom-menu
...
export class CategoryService {
  ...
  // Запрос на получение категорий header-bottom-menu.
  // Создали для этого специальный тип CategoryType.
